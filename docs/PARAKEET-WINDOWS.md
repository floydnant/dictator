...
```
%LOCALAPPDATA%\Dictator\models\parakeet-v2\
...
```powershell
$dir = "$env:LOCALAPPDATA\Dictator\models\parakeet-v2"
...
hf download csukuangfj/sherpa-onnx-nemo-parakeet-tdt-0.6b-v2-int8 `
  ...
  --local-dir "$env:LOCALAPPDATA\Dictator\models\parakeet-v2"
```
...
Target:  %LOCALAPPDATA%\Dictator\models\parakeet-v2\
