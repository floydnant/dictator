...
SCRATCH  := $(HOME)/Library/Caches/DictatorBuild/scratch
...
STAGE    := $(HOME)/Library/Caches/DictatorBuild
APPNAME  := Dictator.app
...
## Only target the exact Dictator executable name so unrelated processes are untouched.
run: app
