...
using Dictator.App.Controls;
using Dictator.App.Design;
using Dictator.App.Views;
using Shouldly;

[assembly: AvaloniaTestApplication(typeof(Dictator.AppTests.TestAppBuilder))]

namespace Dictator.AppTests;
