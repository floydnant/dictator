...
public static class SelfTest
{
    ...
    private static int CheckStorage()
    {
        ...
        var directory = Path.Combine(Path.GetTempPath(), $"dictator-selftest-{Guid.NewGuid():N}");
    ...
    /// </summary>
    /// <remarks>
    /// This is the riskiest thing in the app's structure. <c>Dictator.App</c> targets plain
    /// <c>net10.0</c> and loads <c>Dictator.Platform.Windows</c> by reflection, which is what
