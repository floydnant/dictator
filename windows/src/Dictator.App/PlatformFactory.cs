...
/// <remarks>
/// <para>
/// <b>Why reflection rather than a project reference:</b> <c>Dictator.Platform.Windows</c>
...
{
    private const string AssemblyName = "Dictator.Platform.Windows";
    private const string Namespace = "Dictator.Platform.Windows";
    ...
    /// one is deliberately invisible to it — that is what keeps <c>Dictator.App</c> on plain
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification = "Dictator.Platform.Windows ships whole beside the executable and is "
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification = "Dictator.Platform.Windows is published whole and never trimmed.")]
